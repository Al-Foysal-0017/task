            ...
            <div className="">
                    ...
                    <div className="py-2 mx-3 mt-2 px-2 flex justify-between items-center text-black">
                        ...
                        <div className="pl-2 flex flex-col justify-center">
                            <div className="text-sm font-semibold SclFont">Emil Duvan</div>
                    ...
                    <div className="SclFont mt-3 mb-7 trans justify-center items-center border border-secondary flex rounded-2xl bg-secondary hover:bg-white pb-3 pt-4 px-5 text-sm text-white hover:text-secondary cursor-pointer w-min">
                        Messagenger
